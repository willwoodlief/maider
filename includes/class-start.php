...
class Start {
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_action( 'wp_ajax_'.strtolower( PLUGIN_NAME) .'_admin', $plugin_admin, 'query_survey_ajax_handler' );
	...
	private function define_public_hooks() {
        ...
        $this->loader->add_action( 'wp_ajax_'. strtolower( PLUGIN_NAME) .'_submit_chart_step', $plugin_public, 'send_survey_ajax_handler' );
        $this->loader->add_action( 'wp_ajax_nopriv_'.strtolower( PLUGIN_NAME) .'_submit_chart_step', $plugin_public, 'send_survey_ajax_handler' );
		$this->loader->add_action( 'do_parse_request', $plugin_public, 'do_parse_request',1,3 );
